...
namespace EducationalCompany.Api.Application.Interfaces
{
    ...
    {
        Task<IEnumerable<ParticipantDto>> GetAllIParticipantsAsync(); // Get all participants
        ...
        Task<ParticipantDto> UpdateParticipantAsync(UpdateParticipantDto updateTeacherDto); // Update participant
        Task<bool> DeleteParticipantAsync(Guid id);// Delete participant
