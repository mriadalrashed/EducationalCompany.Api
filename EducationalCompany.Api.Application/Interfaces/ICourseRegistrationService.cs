...
namespace EducationalCompany.Api.Application.Interfaces
{
    ...
    public interface ICourseRegistrationService
    {
        ...
        Task UpdateRegistrationsStatusAsync(Guid id, UpdateRegistrationStatusDto dto); // Update registration
        Task DeleteRegistrationAsync(Guid id);  // Delete registration
        ...
        Task ConfirmRegistrationAsync (Guid id);// Confirm registration
